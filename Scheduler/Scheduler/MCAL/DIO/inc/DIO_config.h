...
#define DIO_PC0_INITIAL_DIRECTION                     DIO_INITIAL_INPUT
#define DIO_PC1_INITIAL_DIRECTION                     DIO_INITIAL_INPUT
#define DIO_PC2_INITIAL_DIRECTION                     DIO_INITIAL_INPUT
#define DIO_PC3_INITIAL_DIRECTION                     DIO_INITIAL_INPUT
#define DIO_PC4_INITIAL_DIRECTION                     DIO_INITIAL_INPUT
#define DIO_PC5_INITIAL_DIRECTION                     DIO_INITIAL_INPUT
...
#define DIO_PA7_INITIAL_VALUE                 DIO_INITIAL_OUTPUT_HIGH
...
#define DIO_PC2_INITIAL_VALUE                 DIO_INITIAL_INPUT_FLOATING
...
#define DIO_PD5_INITIAL_VALUE                 DIO_INITIAL_INPUT_FLOATING
